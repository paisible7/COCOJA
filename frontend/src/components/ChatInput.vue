...
<template>
  ...
  >
    <textarea
      ...
      class="w-full bg-transparent border-0 focus:ring-0 resize-none py-3 px-3 text-gray-100 placeholder-gray-500 leading-relaxed max-h-40 overflow-y-auto"
    ...
    <div class="flex items-center justify-between px-2 pb-1 pt-1">
      <div class="flex items-center gap-1">
        <button
          class="p-2 text-gray-500 hover:text-gray-200 hover:bg-white/5 rounded-lg transition-colors"
      ...
      <div class="flex items-center gap-3">
        <button
          @click="emit('send')"
          class="p-2 bg-primary hover:bg-primary-600 text-white rounded-lg transition-colors shadow-lg shadow-primary/20 disabled:opacity-50 disabled:cursor-not-allowed"
